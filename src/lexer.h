...
typedef enum tokenType {tNONE, tINTEGER, tFLOAT, tDOT, tIDENTIFIER, tSPACE,
  tKEYWORD, tNEWLINE, tLPAREN, tRPAREN, tLBRACKET, tRBRACKET, tCOMMA,
  tSTRING_BEGINING, tSTRING_CONTENT, tSTRING_END, tLBRACE, tRBRACE,
  tSYMBOL_BEGINING, tCOLON2, tBAR, tNOT, tASSIGN, tNOT_EQUAL, tNOT_MATCH,
  tRSHIFT, tOP_ASSIGN, tGT, tGEQ, tCOLON3,
  ...
  tOROP, tLT, tLEQ, tLSHIFT, tCMP, tEQ, tEQQ, tMATCH, tASSOC, tFID} TokenType;
